...
# Connection details
server = 'DESKTOP-9JIEE4Q'  # Replace with your server name
database = 'Management'  # Replace with your database name
...
def validate_login(username, password):
    cursor.execute('SELECT * FROM users WHERE username = ? AND password_ = ?', (username, password))
